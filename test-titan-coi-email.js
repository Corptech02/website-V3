...
async function testTitanCOIEmail() {
    console.log('📧 Testing Titan Email for COI Sending');
    ...
    try {
        ...
        console.log('🔍 Verifying Titan SMTP connection...');
        await transporter.verify();
        console.log('✅ Titan SMTP connection verified!');

        // Prepare email
        const mailOptions = {
            from: 'Grant Corp <grant@vigagency.com>',
...
testTitanCOIEmail().then(success => {
    if (success) {
        console.log('\n🎯 Titan email is working! Ready to send COIs.');
    } else {
        console.log('\n⚠️ Titan email needs configuration.');
    }
});